...
export const QuestionPaperTemplate: React.FC<PaperProps> = ({
    ...
    return (
        <div className="paper-container" style={{ backgroundImage: "url(\"data:image/svg+xml,%3Csvg width='300' height='300' viewBox='0 0 300 300' xmlns='http://www.w3.org/2000/svg'%3E%3Ctext x='150' y='150' fill-opacity='0.15' font-family='Arial' font-size='16' font-weight='900' transform='rotate(-33, 150, 150)' text-anchor='middle'%3E%3Ctspan fill='%230a1a16'%3EPlus2%3C/tspan%3E%3Ctspan fill='%23ff7f50'%3EAI%3C/tspan%3E%3Ctspan fill='%230a1a16'%3E Exam DNA%3C/tspan%3E%3C/text%3E%3C/svg%3E\")", backgroundRepeat: 'repeat' }}>
            ...
            <main className="questions-grid">
                ...
                {/* BOTTOM SPACER: Professional safety buffer */}
                <div style={{ height: '3cm', width: '100%' }}></div>
            </main>
