-- 🛡️ EDUJOURNEY CLEAN SLATE SCHEMA v6.1 (March 2026)
-- =====================================================
-- Complete database schema for fresh installations.
-- WARNING: This will DROP all existing data. Use migrations for live databases.
--
-- ✅ **v6.1 Updates** (March 2026):
--   • Integrated all supabase/migrations through 20260303010000
--   • Added auth.users cleanup prevention (migration 20260303010000)
--   • Fixed RLS policies for year-based scans filtering (migration 017)
--   • Added student_performance_profiles for AI personalization (migration 019)
--   • Enhanced RBAC and subscription handling (migration 020)
--   • Added ai_calibration and exam_historical_patterns (migrations 20260227-20260303)
--   • Fixed calibration RLS policies (migration 20260303000000)
--
-- ✅ **v6.0 Base** (March 2025): REI v3.0 Oracle Support
--   • REI v3.0 Upgrade: Added direct columns for mathematical forecasting
--   • Seed Baseline with: npx tsx migrations/seed_rei_v3.ts
--   • 60-question limit functionality for KCET/NEET predictive mocks
--   • 'FOR ALL' policies for tables using upsert with explicit 'WITH CHECK'
--   • Migration 027: Fixed quiz_attempts schema with proper defaults, dual RLS policies, performance indexes
